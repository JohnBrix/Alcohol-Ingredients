...
import com.alcoholic.alcoholic_ingredients_v2.viewmodel.CocktailDescriptionAdapter;
...
public class CocktailDescription extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(CocktailDescription.this, CocktailController.class);
        ...
        call.enqueue(new Callback<DescriptionModel>() {
            ...
            public void onResponse(Call<DescriptionModel> call, Response<DescriptionModel> response) {
                ...
                try{
                    ...
                    e.printStackTrace();
                    Toast.makeText(CocktailDescription.this, "No data", Toast.LENGTH_SHORT).show();
                }
//                System.out.println("your search:"+ descModel.size());
//
                CocktailDescriptionAdapter mAdapter = new CocktailDescriptionAdapter(CocktailDescription.this, descModel);//constructor
