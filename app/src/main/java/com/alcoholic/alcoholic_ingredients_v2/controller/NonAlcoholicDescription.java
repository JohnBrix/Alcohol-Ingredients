package com.alcoholic.alcoholic_ingredients_v2.controller;
...
import com.alcoholic.alcoholic_ingredients_v2.service.DrinksApiService;
import com.alcoholic.alcoholic_ingredients_v2.R;

import com.alcoholic.alcoholic_ingredients_v2.model.DescriptionModel;
import com.alcoholic.alcoholic_ingredients_v2.viewmodel.NonAlcoholicDescriptionAdapter;
...
public class NonAlcoholicDescription extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(NonAlcoholicDescription.this, NonAlcoholicController.class);
        ...
        call.enqueue(new Callback<DescriptionModel>() {
            ...
            public void onResponse(Call<DescriptionModel> call, Response<DescriptionModel> response) {
                ...
                try{
                    ...
                    e.printStackTrace();
                    Toast.makeText(NonAlcoholicDescription.this, "No data", Toast.LENGTH_SHORT).show();
                }
//                System.out.println("your search:"+ descModel.size());
//
                NonAlcoholicDescriptionAdapter mAdapter = new NonAlcoholicDescriptionAdapter(NonAlcoholicDescription.this, descModel);//constructor
