...
public class CocktailDescriptionAdapter extends RecyclerView.Adapter<CocktailDescriptionAdapter.ViewHolder> {
    //    private Context context;
    private List<DescriptionModel.Drinks> descUtils;


    public CocktailDescriptionAdapter(Context context, List descUtils) {
        //clone
        this.descUtils = descUtils;
    }

    @Override
    public CocktailDescriptionAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_content_description, parent, false);

        CocktailDescriptionAdapter.ViewHolder viewHolder = new CocktailDescriptionAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final CocktailDescriptionAdapter.ViewHolder holder, int position) {
