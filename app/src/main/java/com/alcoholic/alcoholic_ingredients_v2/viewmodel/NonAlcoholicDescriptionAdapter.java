...
public class NonAlcoholicDescriptionAdapter extends RecyclerView.Adapter<NonAlcoholicDescriptionAdapter.ViewHolder> {
    //    private Context context;
    private List<DescriptionModel.Drinks> descUtils;


    public NonAlcoholicDescriptionAdapter(Context context, List descUtils) {
        //clone
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        NonAlcoholicDescriptionAdapter.ViewHolder viewHolder = new NonAlcoholicDescriptionAdapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(final NonAlcoholicDescriptionAdapter.ViewHolder holder, int position) {
